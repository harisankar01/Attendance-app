...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _getCredentials() async {
    ...
    try {
      ...
      print(doc);
      setState(() {
        User.canEdit = doc.data().toString().contains('canEdit')? doc['canEdit'] : true;
        User.firstName = doc['firstName'];
        User.lastName = doc.data().toString().contains('lastName')?doc['lastName']:"";
        User.birthDate = doc.data().toString().contains('birthDate')? doc['birthDate']: '';
        User.address = doc['address'];
        User.WorkType= doc['WorkType'];
      });
    } catch(e) {
      return;
    }
  ...
  void _getProfilePic() async {
    DocumentSnapshot doc = await FirebaseFirestore.instance.collection("Employee").doc(User.id).get();
    setState(() {
      User.profilePicLink = doc.data().toString().contains('profilePic')? doc['profilePic']:null;
    });
  }
